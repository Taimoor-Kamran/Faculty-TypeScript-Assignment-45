let Name = "Muhammad"
let Name_1 = "Muhammad Taimoor "
let Name_2 = "Muhammad Taimoor Kamran"
...
let person1_age:number = 17;
let person2_age:number = 38;
...
let Cities:string [] = ["Texas", "New Jersey", "North Carolina", "Phoenix", "Chicago"]
